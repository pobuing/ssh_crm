                    ...
                    <TD height=25>
                        <FORM id="customerForm" name="customerForm"
                            ...
                            <input type="hidden" name="currentPage" id="currentPageInput"
                                   value="<s:property value="#pb.currentPage"/>"/>
                            <!--隐藏域 每页显示条数-->
                ...
                <TR>
                    <TD>
                        <TABLE id=grid
                            ...
                            <s:iterator value="#pb.list" var="cust">
                                <TR
...
共[<B><s:property value="#pb.totalCount"/></B>]条记录,[<B><s:property value="#pb.totalPage"/></B>]页
,每页显示
<select name="pageSize" onchange="changePageSize($('#pageSizeSelect option:selected').val())" id="pageSizeSelect">
												...
												<option value="3" <s:property
                                                        value="#pb.pageSize==3?'selected':''"/>>3</option>
												<option value="5" <s:property
                                                        value="#pb.pageSize==5?'selected':''"/>>5</option>
												</select>
条
